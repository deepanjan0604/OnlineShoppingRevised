...
$rootScope.search= function(){
	...
	$http({
	       ...
	       url : 'public/products/'+$rootScope.productname,
 ...
 app.controller('gridctrl',[ '$scope','$route','$routeParams', '$rootScope','$http',
	 ...
	 $scope.intitPage=function(){
	 	...
	 	$scope.getProducts=function(){
	 		$http.post('public/products' , $scope.page).then(function(response) {
	 			//$scope.n=0;
	 			$rootScope.products = response.data.content;	
	 		//	$rootScope.page=$rootScope.getNumber(response.data.totalPages);
...
app.controller('historyctrl',[ '$scope', '$rootScope','$http',function($scope,$rootScope, $http)
  ...
  $http({
		method : 'GET',
		url : 'public/order/'+$routeParams.id,
	}).then(function(response) {
		$scope.orders = response.data;
...
app.controller('orderctrl',[ '$scope', '$rootScope','$http',function($scope,$rootScope, $http)
                        	     {
...
//	                           		});	
	 ...
	 $http({
			...
			$rootScope.shippingaddresses = response.data;
